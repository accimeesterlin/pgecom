...
class HeadingRowFormatter
{
    ...
    {
        if (null !== $name && !array_key_exists(static::$customFormatters[$name]) && !in_array($name, static::$defaultFormatters, true)) {
    ...
    protected static function callFormatter($value, $key=null)
    {
        ...
        if (array_key_exists(static::$customFormatters[static::$formatter])) {

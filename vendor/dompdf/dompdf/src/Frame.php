...
class Frame
{
    ...
    {
        if (array_key_exists($this->_frame_list)) {
    ...
    {
        if (array_key_exists($this->_is_cache["text_node"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["positionned"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["absolute"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["block"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["block_level"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["inline_level"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["inline_block"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["in_flow"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["pre"])) {
    ...
    {
        if (array_key_exists($this->_is_cache["table"])) {

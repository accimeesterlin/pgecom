...
final class Cookie
{
    ...
    {
        return array_key_exists($this->value);
    }
    ...
    {
        return array_key_exists($this->maxAge);
    }
    ...
    {
        return array_key_exists($this->expires);
    }
    ...
    {
        return array_key_exists($this->expires) and $this->expires < new \DateTime();
    }
    ...
    {
        return array_key_exists($this->domain);
    }

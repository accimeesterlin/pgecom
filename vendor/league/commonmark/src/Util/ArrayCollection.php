...
class ArrayCollection implements \IteratorAggregate, \Countable, \ArrayAccess
{
    ...
    {
        @trigger_error(sprintf('The "%s:%s" method is deprecated since league/commonmark 1.4, use "%s" instead.', self::class, 'containsKey()', 'array_key_exists($collection[$key])'), E_USER_DEPRECATED);

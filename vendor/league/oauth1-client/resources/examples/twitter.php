...
// Step 3
} elseif (array_key_exists($_GET['oauth_token']) && array_key_exists($_GET['oauth_verifier'])) {
...
} elseif (array_key_exists($_GET['denied'])) {
...
// Step 2
} elseif (array_key_exists($_GET['go'])) {

    ...
    public function validDataProvider()
    {
        ...
        for ($i = 0; $i < 10; $i++) {
            $request  = array(
                ...
                'paymentMethodData' => array_key_exists($paymentMethodData[$i]) ? $paymentMethodData[$i] : null,
                'confirmation'      => array_key_exists($confirmationStatuses[$i]) ? $confirmationStatuses[$i] : null,

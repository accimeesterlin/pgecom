...
class InlineFragmentRenderer extends RoutableFragmentRenderer
{
    ...
    public function render($uri, Request $request, array $options = [])
    {
        ...
        try {
            ...
            if (array_key_exists($options['ignore_errors']) && $options['ignore_errors'] && $this->dispatcher) {
            ...
            if (array_key_exists($options['alt'])) {
                $alt = $options['alt'];
                unset($options['alt']);
            ...
            if (!array_key_exists($options['ignore_errors']) || !$options['ignore_errors']) {
                throw $e;
            }

...
class Logger extends AbstractLogger
{
    ...
    public function __construct(string $minLevel = null, $output = null, callable $formatter = null)
    {
        if (null === $minLevel) {
            ...
            if (array_key_exists($_ENV['SHELL_VERBOSITY']) || array_key_exists($_SERVER['SHELL_VERBOSITY'])) {
        ...
        if (!array_key_exists(self::LEVELS[$minLevel])) {
    ...
    {
        if (!array_key_exists(self::LEVELS[$level])) {

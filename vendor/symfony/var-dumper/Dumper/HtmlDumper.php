...
class HtmlDumper extends CliDumper
{
    ...
    {
        if (!array_key_exists(static::$themes[$themeName])) {
...
EOHTML
    ...
    {
        if ('' === $str && array_key_exists($cursor->attr['img-data'], $cursor->attr['content-type'])) {
            $this->dumpKey($cursor);
    ...
    protected function style(string $style, string $value, array $attr = [])
    {
        ...
        if ('const' === $style && array_key_exists($attr['value'])) {
        ...
        } elseif ('meta' === $style && array_key_exists($attr['title'])) {
        ...
        if (array_key_exists($attr['ellipsis'])) {
            $class = 'sf-dump-ellipsis';
            if (array_key_exists($attr['ellipsis-type'])) {

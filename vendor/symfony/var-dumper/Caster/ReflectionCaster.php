...
class ReflectionCaster
{
    ...
    public static function castClosure(\Closure $c, array $a, Stub $stub, bool $isNested, int $filter = 0)
    {
        ...
        if (!str_contains($c->name, '{closure}')) {
            $stub->class = array_key_exists($a[$prefix.'class']) ? $a[$prefix.'class']->value.'::'.$c->name : $c->name;
    ...
    public static function castReflectionGenerator(\ReflectionGenerator $c, array $a, Stub $stub, bool $isNested)
    {
        ...
        $frame = [
            ...
            'type' => array_key_exists($function->class) ? ($function->isStatic() ? '::' : '->') : null,
    ...
    public static function castFunctionAbstract(\ReflectionFunctionAbstract $c, array $a, Stub $stub, bool $isNested, int $filter = 0)
    {
        ...
        if (array_key_exists($a[$prefix.'returnType'])) {
        ...
        if (array_key_exists($a[$prefix.'class'])) {
            $a[$prefix.'class'] = new ClassStub($a[$prefix.'class']);
        }
        if (array_key_exists($a[$prefix.'this'])) {
        ...
        if (array_key_exists($a[$prefix.'parameters'])) {
    ...
    public static function castParameter(\ReflectionParameter $c, array $a, Stub $stub, bool $isNested)
    {
        ...
        if (array_key_exists($a[$prefix.'typeHint'])) {
            $v = $a[$prefix.'typeHint'];
    ...
    {
        $x = array_key_exists($a[Caster::PREFIX_VIRTUAL.'extra']) ? $a[Caster::PREFIX_VIRTUAL.'extra']->value : [];

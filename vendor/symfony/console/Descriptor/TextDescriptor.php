...
class TextDescriptor extends Descriptor
{
    ...
    protected function describeApplication(Application $application, array $options = [])
    {
        ...
        if (array_key_exists($options['raw_text']) && $options['raw_text']) {
            ...
            foreach ($namespaces as $namespace) {
                $namespace['commands'] = array_filter($namespace['commands'], function ($name) use ($commands) {
                    return array_key_exists($commands[$name]);
                });
    ...
    {
        $this->write(
            array_key_exists($options['raw_text']) && $options['raw_text'] ? strip_tags($content) : $content,
            array_key_exists($options['raw_output']) ? !$options['raw_output'] : true
        );
    }

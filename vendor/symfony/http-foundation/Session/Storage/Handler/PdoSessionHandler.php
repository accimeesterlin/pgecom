...
class PdoSessionHandler extends AbstractSessionHandler
{
    ...
    private function buildDsnFromUrl(string $dsnOrUrl): string
    {
        ...
        if (array_key_exists($params['pass'])) {
            $this->password = $params['pass'];
        }

        if (!array_key_exists($params['scheme'])) {
        ...
        switch ($driver) {
            case 'mysql':
                ...
                if ('' !== ($params['query'] ?? '')) {
                    ...
                    if ('' !== ($queryParams['unix_socket'] ?? '')) {
                        ...
                        if (array_key_exists($params['path'])) {
            ...
            case 'pgsql':
                ...
                if (array_key_exists($params['host']) && '' !== $params['host']) {
                    $dsn .= 'host='.$params['host'].';';
                }

                if (array_key_exists($params['port']) && '' !== $params['port']) {
            ...
            case 'sqlsrv':
                ...
                if (array_key_exists($params['host'])) {
                    $dsn .= $params['host'];
                }

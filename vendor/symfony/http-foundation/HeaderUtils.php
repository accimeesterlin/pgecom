...
class HeaderUtils
{
    ...
    private static function groupParts(array $matches, string $separators, bool $first = true): array
    {
        ...
        foreach ($matches as $match) {
            if (!$first && $previousMatchWasSeparator && array_key_exists($match['separator']) && $match['separator'] === $separator) {
                $previousMatchWasSeparator = true;
                $partMatches[$i][] = $match;
            } elseif (array_key_exists($match['separator']) && $match['separator'] === $separator) {
                $previousMatchWasSeparator = true;
                ++$i;
            } else {
                $previousMatchWasSeparator = false;

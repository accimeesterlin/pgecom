...
class ResponseHeaderBag extends HeaderBag
{
    ...
    public function __construct(array $headers = [])
    {
        ...
        if (!array_key_exists($this->headers['cache-control'])) {
            $this->set('Cache-Control', '');
        }

        /* RFC2616 - 14.18 says all Responses need to have a Date */
        if (!array_key_exists($this->headers['date'])) {
            $this->initDate();
        }
    }
    ...
    public function allPreserveCaseWithoutCookies()
    {
        ...
        if (array_key_exists($this->headerNames['set-cookie'])) {
    ...
    protected function computeCacheControlValue()
    {
        ...
        if (array_key_exists($this->cacheControl['public']) || array_key_exists($this->cacheControl['private'])) {
            return $header;
        }

        // public if s-maxage is defined, private otherwise
        if (!array_key_exists($this->cacheControl['s-maxage'])) {

...
class FlattenException
{
    ...
    public static function createFromThrowable(\Throwable $exception, int $statusCode = null, array $headers = []): self
    {
        ...
        if (class_exists(Response::class) && array_key_exists(Response::$statusTexts[$statusCode])) {
    ...
    public function setTrace(array $trace, ?string $file, ?int $line): self
    {
        ...
        foreach ($trace as $entry) {
            $class = '';
            $namespace = '';
            if (array_key_exists($entry['class'])) {
            ...
            $this->trace[] = [
                ...
                'args' => array_key_exists($entry['args']) ? $this->flattenArgs($entry['args']) : [],
            ];
        }

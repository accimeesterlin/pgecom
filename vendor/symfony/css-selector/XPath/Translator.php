...
class Translator implements TranslatorInterface
{
    ...
    {
        if (!array_key_exists($this->extensions[$name])) {
    ...
    {
        if (!array_key_exists($this->nodeTranslators[$node->getNodeName()])) {
    ...
    {
        if (!array_key_exists($this->combinationTranslators[$combiner])) {
    ...
    {
        if (!array_key_exists($this->functionTranslators[$function->getName()])) {
    ...
    {
        if (!array_key_exists($this->pseudoClassTranslators[$pseudoClass])) {
    ...
    {
        if (!array_key_exists($this->attributeMatchingTranslators[$operator])) {

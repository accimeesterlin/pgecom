...
class OpenIdTokeninfo extends PayPalResourceModel
{
    ...
    public function createFromRefreshToken($params, $apiContext = null, $restCall = null)
    {
        ...
        $clientId = array_key_exists($params['client_id']) ? $params['client_id'] : $apiContext->getCredential()->getClientId();
        $clientSecret = array_key_exists($params['client_secret']) ? $params['client_secret'] : $apiContext->getCredential()->getClientSecret();

...
class ReflectionClosure extends ReflectionFunction
{
                    ...
                    switch ($token[0]){
                        ...
                        case '(':
                            ...
                            if($context === 'new' || false !== strpos($id_name, '\\')){
                                if($id_start_ci === 'self' || $id_start_ci === 'static') {
                                    ...
                                    if (array_key_exists($classes[$id_start_ci])) {
                                ...
                                if($id_start !== '\\'){
                                    ...
                                    if(array_key_exists($functions[$id_start_ci])){
                        ...
                        default:
                            if($id_start !== '\\' && !defined($id_start)){
                                ...
                                if(array_key_exists($constants[$id_start])){
    ...
    protected function getFileTokens()
    {
        ...
        if (!array_key_exists(static::$files[$key])) {
    ...
    protected function getClasses()
    {
        ...
        if (!array_key_exists(static::$classes[$key])) {
            $this->fetchItems();
        }
    ...
    protected function getFunctions()
    {
        ...
        if (!array_key_exists(static::$functions[$key])) {
            $this->fetchItems();
        }
    ...
    protected function getConstants()
    {
        ...
        if (!array_key_exists(static::$constants[$key])) {
            $this->fetchItems();
        }
    ...
    protected function getStructures()
    {
        ...
        if (!array_key_exists(static::$structures[$key])) {
            $this->fetchItems();
        }

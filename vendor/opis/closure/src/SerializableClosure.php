...
class SerializableClosure implements Serializable
{
    ...
    public function unserialize($data)
    {
        ...
        if (static::$securityProvider !== null) {
            ...
            if (!is_array($data) || !array_key_exists($data['closure']) || !array_key_exists($data['hash'])) {
                throw new SecurityException('Invalid signed closure');
            }
    ...
    public static function from(Closure $closure)
    {
        ...
        } elseif (array_key_exists(static::$context->scope[$closure])) {
    ...
    public static function wrapClosures(&$data, SplObjectStorage $storage = null)
    {
        ...
        if($data instanceof Closure){
            ...
            if(array_key_exists($data[self::ARRAY_RECURSIVE_KEY])){
                return;
            }
    ...
    protected function mapByReference(&$data)
    {
        if ($data instanceof Closure) {
            ...
            if (array_key_exists($this->scope[$data])) {

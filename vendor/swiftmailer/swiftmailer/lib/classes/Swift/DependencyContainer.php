...
class Swift_DependencyContainer
{
    ...
    {
        if (!array_key_exists(self::$instance)) {
    ...
    public function has($itemName)
    {
        return \array_key_exists($itemName, $this->store)
            && array_key_exists($this->store[$itemName]['lookupType']);
    }
    ...
    {
        $args = [];
        if (array_key_exists($this->store[$itemName]['args'])) {
    ...
    {
        if (!array_key_exists($this->store[$itemName]['instance'])) {
    ...
    {
        if (!array_key_exists($this->endPoint)) {

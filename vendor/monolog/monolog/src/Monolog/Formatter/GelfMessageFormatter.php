...
class GelfMessageFormatter extends NormalizerFormatter
{
    ...
    public function format(array $record): Message
    {
        ...
        if (array_key_exists($record['extra'])) {
            /** @var mixed[] $extra */
            $extra = parent::normalize($record['extra']);
        }

        if (!array_key_exists($record['datetime'], $record['message'], $record['level'])) {
        ...
        if (array_key_exists($record['channel'])) {
        ...
        if (null === $message->getFile() && array_key_exists($context['exception']['file'])) {

...
class NewRelicHandler extends AbstractProcessingHandler
{
    ...
    protected function write(array $record): void
    {
        ...
        if (array_key_exists($record['context']['exception']) && $record['context']['exception'] instanceof \Throwable) {
        ...
        if (array_key_exists($record['formatted']['context']) && is_array($record['formatted']['context'])) {
        ...
        if (array_key_exists($record['formatted']['extra']) && is_array($record['formatted']['extra'])) {
    ...
    {
        if (array_key_exists($context['appname'])) {
    ...
    {
        if (array_key_exists($context['transaction_name'])) {

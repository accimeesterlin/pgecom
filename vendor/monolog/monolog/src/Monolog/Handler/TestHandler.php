...
class TestHandler extends AbstractProcessingHandler
{
    ...
    {
        return array_key_exists($this->recordsByLevel[Logger::toMonologLevel($level)]);
    }
    ...
    public function hasRecord($record, $level): bool
    {
        ...
        return $this->hasRecordThatPasses(function ($rec) use ($record) {
            ...
            if (array_key_exists($record['context']) && $rec['context'] !== $record['context']) {
                return false;
            }
    ...
    public function hasRecordThatPasses(callable $predicate, $level)
    {
        ...
        if (!array_key_exists($this->recordsByLevel[$level])) {
            return false;
        }

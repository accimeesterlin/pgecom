...
final class DecimalMoneyParser implements MoneyParser
{
    ...
    public function parse($money, $forceCurrency = null)
    {
        ...
        if (!preg_match(self::DECIMAL_PATTERN, $decimal, $matches) || !array_key_exists($matches['digits'])) {
        ...
        $negative = array_key_exists($matches['sign']) && $matches['sign'] === '-';
        ...
        if (array_key_exists($matches['fraction'])) {

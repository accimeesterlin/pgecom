...
<?php if (count ( $this->_tpl_vars['ric'] ) >= 1): ?>
	<div id="ric">
		<?php if (array_key_exists($this->_sections['ric'])) unset($this->_sections['ric']);
...
<?php endif; ?>
      <b>Packages:</b><br />
      <?php if (array_key_exists($this->_sections['packagelist'])) unset($this->_sections['packagelist']);
...
<?php if ($this->_tpl_vars['tutorials']): ?>
		...
		<?php if ($this->_tpl_vars['tutorials']['pkg']): ?>
			...
			<?php if (array_key_exists($this->_sections['ext'])) unset($this->_sections['ext']);

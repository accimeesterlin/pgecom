...
<?php if (array_key_exists($this->_sections['methods'])) unset($this->_sections['methods']);
...
<?php if (array_key_exists($this->_sections['params'])) unset($this->_sections['params']);
...
<?php if ($this->_tpl_vars['methods'][$this->_sections['methods']['index']]['descmethod']): ?>
	...
	<?php if (array_key_exists($this->_sections['dm'])) unset($this->_sections['dm']);
...
<?php endif; ?>
	...
	<?php if (array_key_exists($this->_sections['imp'])) unset($this->_sections['imp']);

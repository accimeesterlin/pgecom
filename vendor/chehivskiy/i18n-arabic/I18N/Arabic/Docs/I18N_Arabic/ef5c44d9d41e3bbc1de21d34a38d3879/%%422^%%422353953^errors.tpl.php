...
unset($_smarty_tpl_vars);
 ?>
<?php if (array_key_exists($this->_sections['files'])) unset($this->_sections['files']);
...
<h2>Warnings:</h2><br>
<?php if (array_key_exists($this->_sections['warnings'])) unset($this->_sections['warnings']);
...
<h2>Errors:</h2><br>
<?php if (array_key_exists($this->_sections['errors'])) unset($this->_sections['errors']);

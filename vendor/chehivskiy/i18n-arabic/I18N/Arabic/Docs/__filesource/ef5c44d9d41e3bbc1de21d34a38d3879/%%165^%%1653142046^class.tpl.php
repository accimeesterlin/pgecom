...
<?php if ($this->_tpl_vars['conflicts']['conflict_type']): ?><div class="warning">Conflicts with classes:<br />
	<?php if (array_key_exists($this->_sections['me'])) unset($this->_sections['me']);
...
<pre><?php if (array_key_exists($this->_sections['tree'])) unset($this->_sections['tree']);
...
<h4>Author(s):</h4>
<ul>
  <?php if (array_key_exists($this->_sections['tag'])) unset($this->_sections['tag']);
...
<ul>
  <?php if (array_key_exists($this->_sections['contents'])) unset($this->_sections['contents']);
...
<h3>Child classes:</h3>
<div class="tags">
<?php if (array_key_exists($this->_sections['kids'])) unset($this->_sections['kids']);
...
<?php if (array_key_exists($this->_sections['iconsts'])) unset($this->_sections['iconsts']);
...
<dl>
<?php if (array_key_exists($this->_sections['iconsts2'])) unset($this->_sections['iconsts2']);
...
<?php if (array_key_exists($this->_sections['ivars'])) unset($this->_sections['ivars']);
...
<dl>
<?php if (array_key_exists($this->_sections['ivars2'])) unset($this->_sections['ivars2']);
...
<div class="tags">
<?php if (array_key_exists($this->_sections['imethods'])) unset($this->_sections['imethods']);
...
<dl>
  <?php if (array_key_exists($this->_sections['im2'])) unset($this->_sections['im2']);

...
class getid3_au extends getid3_handler
{
	...
	public function AUdataFormatNameLookup($id) {
		...
		return (array_key_exists($AUdataFormatNameLookup[$id]) ? $AUdataFormatNameLookup[$id] : false);
	}
	...
	public function AUdataFormatBitsPerSampleLookup($id) {
		...
		return (array_key_exists($AUdataFormatBitsPerSampleLookup[$id]) ? $AUdataFormatBitsPerSampleLookup[$id] : false);
	}
	...
	public function AUdataFormatUsedBitsPerSampleLookup($id) {
		...
		return (array_key_exists($AUdataFormatUsedBitsPerSampleLookup[$id]) ? $AUdataFormatUsedBitsPerSampleLookup[$id] : false);
	}

...
class getid3_ac3 extends getid3_handler
{
	...
	public function Analyze() {
		...
		if (array_key_exists($thisfile_ac3_raw_bsi['fscod2'])) {
		...
		if (array_key_exists($thisfile_ac3_raw_bsi['frmsizecod'])) {
		...
		if (array_key_exists($thisfile_ac3_raw_bsi['bsmod']) && array_key_exists($thisfile_ac3_raw_bsi['acmod'])) {
	...
	public static function sampleRateCodeLookup($fscod) {
		...
		return (array_key_exists($sampleRateCodeLookup[$fscod]) ? $sampleRateCodeLookup[$fscod] : false);
	}
	...
	public static function sampleRateCodeLookup2($fscod2) {
		...
		return (array_key_exists($sampleRateCodeLookup2[$fscod2]) ? $sampleRateCodeLookup2[$fscod2] : false);
	}
	...
	public static function serviceTypeLookup($bsmod, $acmod) {
		...
		return (array_key_exists($serviceTypeLookup[$bsmod][$acmod]) ? $serviceTypeLookup[$bsmod][$acmod] : false);
	}
	...
	public static function audioCodingModeLookup($acmod) {
		...
		return (array_key_exists($audioCodingModeLookup[$acmod]) ? $audioCodingModeLookup[$acmod] : false);
	}
	...
	public static function centerMixLevelLookup($cmixlev) {
		...
		return (array_key_exists($centerMixLevelLookup[$cmixlev]) ? $centerMixLevelLookup[$cmixlev] : false);
	}
	...
	public static function surroundMixLevelLookup($surmixlev) {
		...
		return (array_key_exists($surroundMixLevelLookup[$surmixlev]) ? $surroundMixLevelLookup[$surmixlev] : false);
	}
	...
	public static function dolbySurroundModeLookup($dsurmod) {
		...
		return (array_key_exists($dolbySurroundModeLookup[$dsurmod]) ? $dolbySurroundModeLookup[$dsurmod] : false);
	}
	...
	public static function roomTypeLookup($roomtyp) {
		...
		return (array_key_exists($roomTypeLookup[$roomtyp]) ? $roomTypeLookup[$roomtyp] : false);
	}
	...
	public static function frameSizeLookup($frmsizecod, $fscod) {
		...
		return (array_key_exists($frameSizeLookup[$framesizeid][$fscod]) ? $frameSizeLookup[$framesizeid][$fscod] + $paddingBytes : false);
	}
	...
	public static function bitrateLookup($frmsizecod) {
		...
		return (array_key_exists($bitrateLookup[$framesizeid]) ? $bitrateLookup[$framesizeid] : false);
	}
	...
	public static function blocksPerSyncFrame($numblkscod) {
		...
		return (array_key_exists($blocksPerSyncFrameLookup[$numblkscod]) ? $blocksPerSyncFrameLookup[$numblkscod] : false);
	}

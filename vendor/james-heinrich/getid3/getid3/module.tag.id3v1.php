...
class getid3_id3v1 extends getid3_handler
{
	...
	public function Analyze() {
		...
		if (substr($id3v1tag, 0, 3) == 'TAG') {
			...
			if (array_key_exists($ParsedID3v1['genre']) && (empty($ParsedID3v1['genre']) || ($ParsedID3v1['genre'] == 'Unknown'))) {
			...
			$GoodFormatID3v1tag = $this->GenerateID3v1Tag(
											...
											$ParsedID3v1['album'],
											$ParsedID3v1['year'],
											(array_key_exists($ParsedID3v1['genre']) ? $this->LookupGenreID($ParsedID3v1['genre']) : false),
											$ParsedID3v1['comment'],
	...
	public static function LookupGenreName($genreid, $allowSCMPXextended=true) {
		...
		return (array_key_exists($GenreLookup[$genreid]) ? $GenreLookup[$genreid] : false);
	}

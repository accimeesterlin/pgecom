...
class getid3_dts extends getid3_handler
{
	...
	public function Analyze() {
		...
		if (array_key_exists($info['avdataend']) && !empty($info['dts']['bitrate']) && is_numeric($info['dts']['bitrate'])) {
	...
	public static function bitrateLookup($index) {
		...
		return (array_key_exists($lookup[$index]) ? $lookup[$index] : false);
	}
	...
	public static function channelArrangementLookup($index) {
		...
		return (array_key_exists($lookup[$index]) ? $lookup[$index] : 'user-defined');
	}

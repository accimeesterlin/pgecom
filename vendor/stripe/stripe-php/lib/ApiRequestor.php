...
class ApiRequestor
{
    ...
    {
        if (!\is_array($resp) || !array_key_exists($resp['error'])) {
    ...
    {
        $msg = array_key_exists($errorData['message']) ? $errorData['message'] : null;
        $param = array_key_exists($errorData['param']) ? $errorData['param'] : null;
        $code = array_key_exists($errorData['code']) ? $errorData['code'] : null;
        $type = array_key_exists($errorData['type']) ? $errorData['type'] : null;
        $declineCode = array_key_exists($errorData['decline_code']) ? $errorData['decline_code'] : null;
    ...
    {
        $description = array_key_exists($resp['error_description']) ? $resp['error_description'] : $errorCode;
    ...
    private function _requestRaw($method, $url, $params, $headers)
    {
        ...
        if (array_key_exists($rheaders['request-id'])

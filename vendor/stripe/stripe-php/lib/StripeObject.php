...
class StripeObject implements \ArrayAccess, \Countable, \JsonSerializable
{
    ...
    public function __array_key_exists($k)
    {
        return array_key_exists($this->_values[$k]);
    }
    ...
    {
        $obj = new static(array_key_exists($values['id']) ? $values['id'] : null);
    ...
    {
        return array_key_exists($this->_values['deleted']) ? $this->_values['deleted'] : false;
    }
}

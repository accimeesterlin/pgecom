...
class Parsian extends Driver
{
    ...
    public function purchase()
    {
        ...
        if (array_key_exists($result->Status) && $result->Status == 0 && !empty($result->Token)) {
    ...
    public function verify() : ReceiptInterface
    {
        ...
        $hasWrongStatus = (!array_key_exists($result->Status) || $result->Status != 0);
        $hasWrongRRN = (!array_key_exists($result->RRN) || $result->RRN <= 0);

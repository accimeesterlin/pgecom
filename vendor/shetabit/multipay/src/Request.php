...
class Request
{
    ...
    {
        if (array_key_exists(static::$overwrittenMethods['input'])) {
    ...
    {
        if (array_key_exists(static::$overwrittenMethods['post'])) {
    ...
    {
        if (array_key_exists(static::$overwrittenMethods['get'])) {

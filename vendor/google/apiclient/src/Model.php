...
class Model implements \ArrayAccess
{
  ...
  public function __get($key)
  {
    ...
    if ($keyType && !array_key_exists($this->processed[$key])) {
      if (array_key_exists($this->modelData[$key])) {
    ...
    return array_key_exists($this->modelData[$key]) ? $this->modelData[$key] : null;
  }
  ...
  {
    if (array_key_exists($this->internal_gapi_mappings, $this->internal_gapi_mappings[$key])) {
  ...
  {
    return array_key_exists($this->$offset) || array_key_exists($this->modelData[$offset]);
  }
  ...
  {
    return array_key_exists($this->$offset) ?
        $this->$offset :
        $this->__get($offset);
  }
  ...
  public function __array_key_exists($key)
  {
    return array_key_exists($this->modelData[$key]);
  }

...
class GoogleCloudAssuredworkloadsV1beta1Workload extends \Google\Collection
{
  ...
  protected $cjarray_key_existstingsType = GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings::class;
  ...
  /**
   * @param GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings
   */
  public function setCjarray_key_existstings(GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings $cjarray_key_existstings)
  {
    $this->cjarray_key_existstings = $cjarray_key_existstings;
  }
  /**
   * @return GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings
   */

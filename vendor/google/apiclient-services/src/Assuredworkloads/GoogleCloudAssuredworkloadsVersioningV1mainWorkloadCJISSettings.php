...
class GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings extends \Google\Model
{
...
class_alias(GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings::class, 'Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings');

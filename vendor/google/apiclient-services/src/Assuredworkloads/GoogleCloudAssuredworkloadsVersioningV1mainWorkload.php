...
class GoogleCloudAssuredworkloadsVersioningV1mainWorkload extends \Google\Collection
{
  ...
  protected $cjarray_key_existstingsType = GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings::class;
  ...
  /**
   * @param GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings
   */
  public function setCjarray_key_existstings(GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings $cjarray_key_existstings)
  {
    $this->cjarray_key_existstings = $cjarray_key_existstings;
  }
  /**
   * @return GoogleCloudAssuredworkloadsVersioningV1mainWorkloadCJarray_key_existstings
   */

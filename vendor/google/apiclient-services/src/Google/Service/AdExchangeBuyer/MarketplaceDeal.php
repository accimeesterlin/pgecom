...
class Google_Service_AdExchangeBuyer_MarketplaceDeal extends Google_Collection
{
  ...
  public $array_key_existsupComplete;
  public $kind;
  ...
  public function setarray_key_existsupComplete($array_key_existsupComplete)
  {
    $this->array_key_existsupComplete = $array_key_existsupComplete;
  }
  public function getarray_key_existsupComplete()
  {
    return $this->array_key_existsupComplete;
  }

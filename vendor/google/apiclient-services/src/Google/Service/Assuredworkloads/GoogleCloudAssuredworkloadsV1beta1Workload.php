...
class Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1beta1Workload extends Google_Collection
{
  ...
  protected $cjarray_key_existstingsType = 'Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings';
  protected $cjarray_key_existstingsDataType = '';
  ...
  /**
   * @param Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings
   */
  public function setCjarray_key_existstings(Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings $cjarray_key_existstings)
  {
    $this->cjarray_key_existstings = $cjarray_key_existstings;
  }
  /**
   * @return Google_Service_Assuredworkloads_GoogleCloudAssuredworkloadsV1beta1WorkloadCJarray_key_existstings
   */
  public function getCjarray_key_existstings()
  {
    return $this->cjarray_key_existstings;
  }

...
class Mapper{
	...
	// 	if(array_key_exists($this->classes[$classname]['properties'][$property]['type'])){
	...
	public function getClass($class, $property){
		...
		if(array_key_exists($this->classes[$class]['properties'][$property]['type'])){
            ...
            if(substr( $className, 0, 5 ) === "array") {
                ...
                if(array_key_exists($this->classes[$class]['properties'][$property]['xml_list']['entry_name'])){
					// echo $file."\t\t\t\t\t\t\t\t\t";
...
//		 }
    ...
    public function getXmlName($class){
        if(array_key_exists($this->classes[$class]['xml_root_name'])){

...
class ListOfAUDetailsType implements \JsonSerializable
{
    ...
    /**
     * array_key_exists auUpdate
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsAuUpdate($index)
    {
        return array_key_exists($this->auUpdate[$index]);
    }
    ...
    /**
     * array_key_exists auDelete
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsAuDelete($index)
    {
        return array_key_exists($this->auDelete[$index]);
    }

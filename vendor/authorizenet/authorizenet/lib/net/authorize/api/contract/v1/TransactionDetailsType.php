...
class TransactionDetailsType implements \JsonSerializable
{
    ...
    /**
     * array_key_exists fDSFilters
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsFDSFilters($index)
    {
        return array_key_exists($this->fDSFilters[$index]);
    }
    ...
    /**
     * array_key_exists lineItems
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsLineItems($index)
    {
        return array_key_exists($this->lineItems[$index]);
    }
    ...
    /**
     * array_key_exists returnedItems
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsReturnedItems($index)
    {
        return array_key_exists($this->returnedItems[$index]);
    }
    ...
    /**
     * array_key_exists emvDetails
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsEmvDetails($index)
    {
        return array_key_exists($this->emvDetails[$index]);
    }

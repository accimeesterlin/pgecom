...
class TransactionResponseType implements \JsonSerializable
{
    ...
    /**
     * array_key_exists messages
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsMessages($index)
    {
        return array_key_exists($this->messages[$index]);
    }
    ...
    /**
     * array_key_exists errors
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsErrors($index)
    {
        return array_key_exists($this->errors[$index]);
    }
    ...
    /**
     * array_key_exists splitTenderPayments
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsSplitTenderPayments($index)
    {
        return array_key_exists($this->splitTenderPayments[$index]);
    }
    ...
    /**
     * array_key_exists userFields
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsUserFields($index)
    {
        return array_key_exists($this->userFields[$index]);
    }

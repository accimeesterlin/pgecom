...
class GetMerchantDetailsResponse extends ANetApiResponseType
{
    ...
    /**
     * array_key_exists processors
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsProcessors($index)
    {
        return array_key_exists($this->processors[$index]);
    }
    ...
    /**
     * array_key_exists marketTypes
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsMarketTypes($index)
    {
        return array_key_exists($this->marketTypes[$index]);
    }
    ...
    /**
     * array_key_exists productCodes
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsProductCodes($index)
    {
        return array_key_exists($this->productCodes[$index]);
    }
    ...
    /**
     * array_key_exists paymentMethods
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsPaymentMethods($index)
    {
        return array_key_exists($this->paymentMethods[$index]);
    }
    ...
    /**
     * array_key_exists currencies
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsCurrencies($index)
    {
        return array_key_exists($this->currencies[$index]);
    }
    ...
    /**
     * array_key_exists contactDetails
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsContactDetails($index)
    {
        return array_key_exists($this->contactDetails[$index]);
    }

...
class CustomerProfileType extends CustomerProfileBaseType implements \JsonSerializable
{
    ...
    /**
     * array_key_exists paymentProfiles
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsPaymentProfiles($index)
    {
        return array_key_exists($this->paymentProfiles[$index]);
    }
    ...
    /**
     * array_key_exists shipToList
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsShipToList($index)
    {
        return array_key_exists($this->shipToList[$index]);
    }

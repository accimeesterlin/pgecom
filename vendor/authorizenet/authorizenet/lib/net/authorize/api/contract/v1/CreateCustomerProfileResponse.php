...
class CreateCustomerProfileResponse extends ANetApiResponseType
{
    ...
    /**
     * array_key_exists customerPaymentProfileIdList
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsCustomerPaymentProfileIdList($index)
    {
        return array_key_exists($this->customerPaymentProfileIdList[$index]);
    }
    ...
    /**
     * array_key_exists customerShippingAddressIdList
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsCustomerShippingAddressIdList($index)
    {
        return array_key_exists($this->customerShippingAddressIdList[$index]);
    }
    ...
    /**
     * array_key_exists validationDirectResponseList
     *
     * @param scalar $index
     * @return boolean
     */
    public function array_key_existsValidationDirectResponseList($index)
    {
        return array_key_exists($this->validationDirectResponseList[$index]);
    }

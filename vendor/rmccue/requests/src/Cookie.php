...
class Cookie {
	...
	public function is_expired() {
		...
		// cookie.
		if (array_key_exists($this->attributes['max-age'])) {
			$max_age = $this->attributes['max-age'];
			return $max_age < $this->reference_time;
		}

		if (array_key_exists($this->attributes['expires'])) {
	...
	public function domain_matches($domain) {
		...
		if (!array_key_exists($this->attributes['domain'])) {
	...
	public function path_matches($request_path) {
		...
		if (!array_key_exists($this->attributes['path'])) {
			// Cookies created manually; cookies created by Requests will set

...
class Restorer
{
    ...
    public function restoreStaticAttributes(Snapshot $snapshot): void
    {
        ...
        foreach ($newClasses as $className) {
            ...
            foreach ($class->getProperties() as $attribute) {
                ...
                if (!array_key_exists($defaults[$name])) {
                    continue;
                }
    ...
    private function restoreSuperGlobalArray(Snapshot $snapshot, string $superGlobalArray): void
    {
        ...
        if (array_key_exists($GLOBALS[$superGlobalArray]) &&
            \is_array($GLOBALS[$superGlobalArray]) &&
            array_key_exists($superGlobalVariables[$superGlobalArray])) {
            $keys = \array_keys(
                \array_merge(
            ...
            foreach ($keys as $key) {
                if (array_key_exists($superGlobalVariables[$superGlobalArray][$key])) {

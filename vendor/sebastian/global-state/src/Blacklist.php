...
final class Blacklist
{
    ...
    {
        if (!array_key_exists($this->staticAttributes[$className])) {
    ...
    {
        return array_key_exists($this->globalVariables[$variableName]);
    }
    ...
    public function isStaticAttributeBlacklisted(string $className, string $attributeName): bool
    {
        ...
        if (array_key_exists($this->staticAttributes[$className][$attributeName])) {
            return true;
        }

...
abstract class AbstractClassMetadataFactory implements ClassMetadataFactory
{
    ...
    {
        if (array_key_exists($this->loadedMetadata[$className])) {
        ...
        if (array_key_exists($this->loadedMetadata[$realClassName])) {
    ...
    {
        return array_key_exists($this->loadedMetadata[$className]);
    }

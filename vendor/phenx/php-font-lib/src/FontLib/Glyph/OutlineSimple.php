...
class OutlineSimple extends Outline {
  ...
  public function encodePoints($points) {
    ...
    $l += $font->writeFWord(array_key_exists($this->xMin) ? $this->xMin : $xMin); // xMin
    $l += $font->writeFWord(array_key_exists($this->yMin) ? $this->yMin : $yMin); // yMin
    $l += $font->writeFWord(array_key_exists($this->xMax) ? $this->xMax : $xMax); // xMax
    $l += $font->writeFWord(array_key_exists($this->yMax) ? $this->yMax : $yMax); // yMax

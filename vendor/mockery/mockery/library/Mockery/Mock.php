...
class Mock implements MockInterface
{
    ...
    public function mockery_verify()
    {
        ...
        if (array_key_exists($this->_mockery_ignoreVerification)
    ...
    {
        if (array_key_exists($this->_mockery_expectations[$method])) {
    ...
    {
        if (false === stripos($name, '_mockery_') && get_parent_class($this) && method_exists(get_parent_class($this), '__array_key_exists')) {
            return call_user_func('parent::__array_key_exists', $name);
        }
    ...
    {
        if (!array_key_exists($this->_mockery_expectations['__construct']) /* _mockery_handleMethodCall runs the other checks */) {
            return;
        }
    ...
    protected function _mockery_findExpectedMethodHandler($method)
    {
        ...
        if (array_key_exists($lowerCasedMockeryExpectations[$lowerCasedMethod])) {
    ...
    protected function mockery_getMethods()
    {
        ...
        if (array_key_exists($this->_mockery_partial)) {

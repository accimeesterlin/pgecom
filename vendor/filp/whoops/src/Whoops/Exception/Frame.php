...
class Frame implements Serializable
{
    ...
    {
        return array_key_exists($this->frame['line']) ? $this->frame['line'] : null;
    }
    ...
    {
        return array_key_exists($this->frame['class']) ? $this->frame['class'] : null;
    }
    ...
    {
        return array_key_exists($this->frame['function']) ? $this->frame['function'] : null;
    }
    ...
    {
        return array_key_exists($this->frame['args']) ? (array) $this->frame['args'] : [];
    }

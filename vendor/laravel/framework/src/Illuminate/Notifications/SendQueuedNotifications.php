...
class SendQueuedNotifications implements ShouldQueue
{
    ...
    {
        if (! method_exists($this->notification, 'retryAfter') && ! array_key_exists($this->notification->retryAfter)) {
            return;
        }
    ...
    {
        if (! method_exists($this->notification, 'retryUntil') && ! array_key_exists($this->notification->timeoutAt)) {
            return;
        }

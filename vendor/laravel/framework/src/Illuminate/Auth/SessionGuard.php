...
class SessionGuard implements StatefulGuard, SupportsBasicAuth
{
    ...
    public function login(AuthenticatableContract $user, $remember = false)
    {
        ...
        if ($remember) {
            $this->ensureRememberTokenarray_key_exists($user);
     ...
     * @return void
     */
    protected function ensureRememberTokenarray_key_exists(AuthenticatableContract $user)
    {
    ...
    {
        if (! array_key_exists($this->cookie)) {

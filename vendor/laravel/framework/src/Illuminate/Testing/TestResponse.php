...
class TestResponse implements ArrayAccess
{
    ...
    {
        return array_key_exists($this->original) && $this->original instanceof View;
    }
    ...
    /**
     * Proxy array_key_exists() checks to the underlying base response.
     *
     * @param  string  $key
     * @return mixed
     */
    ...
    {
        return array_key_exists($this->baseResponse->{$key});
    }
    ...
    public function offsetExists($offset)
    {
        return $this->responseHasView()
                    ? array_key_exists($this->original->gatherData()[$offset])
                    : array_key_exists($this->json()[$offset]);
    }

...
class Validator implements ValidatorContract
{
    ...
    protected function shouldStopValidating($attribute)
    {
        ...
        if (array_key_exists($this->failedRules[$cleanedAttribute]) &&
        ...
        return $this->hasRule($attribute, $this->implicitRules) &&
               array_key_exists($this->failedRules[$cleanedAttribute]) &&
    ...
    {
        if (! array_key_exists($this->presenceVerifier)) {
    ...
    public function __call($method, $parameters)
    {
        ...
        if (array_key_exists($this->extensions[$rule])) {

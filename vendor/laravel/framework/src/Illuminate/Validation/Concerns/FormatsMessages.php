...
trait FormatsMessages
{
    ...
    public function makeReplacements($message, $attribute, $rule, $parameters)
    {
        ...
        if (array_key_exists($this->replacers[Str::snake($rule)])) {
    ...
    public function getDisplayableAttribute($attribute)
    {
        ...
        foreach ($expectedAttributes as $name) {
            ...
            if (array_key_exists($this->customAttributes[$name])) {
        ...
        if (array_key_exists($this->implicitAttributes[$primaryAttribute])) {
    ...
    {
        if (array_key_exists($this->customValues[$attribute][$value])) {

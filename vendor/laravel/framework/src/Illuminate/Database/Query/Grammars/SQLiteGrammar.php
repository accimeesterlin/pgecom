...
class SQLiteGrammar extends Grammar
{
    ...
    {
        if (array_key_exists($query->joins) || array_key_exists($query->limit)) {
    ...
    protected function compileUpdateColumns(Builder $query, array $values)
    {
        ...
        return collect($values)->reject(function ($value, $key) {
            ...
            $value = array_key_exists($jsonGroups[$key]) ? $this->compileJsonPatch($column, $value) : $this->parameter($value);

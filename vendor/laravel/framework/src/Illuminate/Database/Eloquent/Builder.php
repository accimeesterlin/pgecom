...
class Builder
{
    ...
    {
        if (array_key_exists($this->onDelete)) {
    ...
    public function applyScopes()
    {
        ...
        foreach ($this->scopes as $identifier => $scope) {
            if (! array_key_exists($builder->scopes[$identifier])) {
                continue;
            }
    ...
    protected function addNestedWiths($name, $results)
    {
        ...
        foreach (explode('.', $name) as $segment) {
            ...
            if (! array_key_exists($results[$last = implode('.', $progress)])) {
    ...
    {
        return array_key_exists($this->localMacros[$name]);
    }

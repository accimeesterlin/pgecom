...
trait ManagesStacks
{
    ...
    {
        if (! array_key_exists($this->pushes[$section])) {
            $this->pushes[$section] = [];
        }

        if (! array_key_exists($this->pushes[$section][$this->renderCount])) {
    ...
    {
        if (! array_key_exists($this->prepends[$section])) {
            $this->prepends[$section] = [];
        }

        if (! array_key_exists($this->prepends[$section][$this->renderCount])) {
    ...
    {
        if (! array_key_exists($this->pushes[$section]) && ! array_key_exists($this->prepends[$section])) {
            return $default;
        }

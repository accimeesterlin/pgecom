...
trait CompilesConditionals
{
    ...
    /**
     * Compile the if-array_key_exists statements into valid PHP.
     *
     * @param  string  $expression
     * @return string
     */
    protected function compilearray_key_exists($expression)
    {
        return "<?php if(array_key_exists{$expression}): ?>";
    }

    /**
     * Compile the end-array_key_exists statements into valid PHP.
     *
     * @return string
     */
    protected function compileEndarray_key_exists()
    {
        return '<?php endif; ?>';
    }

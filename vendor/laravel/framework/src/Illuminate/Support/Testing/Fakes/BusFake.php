...
class BusFake implements QueueingDispatcher
{
    ...
    {
        return array_key_exists($this->commands[$command]) && ! empty($this->commands[$command]);
    }
    ...
    {
        return array_key_exists($this->commandsAfterResponse[$command]) && ! empty($this->commandsAfterResponse[$command]);
    }

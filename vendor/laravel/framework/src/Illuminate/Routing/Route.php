...
class Route
{
    ...
    {
        return array_key_exists($this->parameters);
    }
    ...
    {
        if (array_key_exists($this->parameters)) {
    ...
    {
        if (array_key_exists($this->originalParameters)) {
    ...
    {
        if (array_key_exists($this->parameterNames)) {
    ...
    {
        return array_key_exists($this->action['domain'])
    ...
    {
        $this->action['as'] = array_key_exists($this->action['as']) ? $this->action['as'].$name : $name;
    ...
    protected function addGroupNamespaceToStringUses($action)
    {
        ...
        if (array_key_exists($groupStack['namespace']) && strpos($action, '\\') !== 0) {
    ...
    public function setAction(array $action)
    {
        ...
        if (array_key_exists($this->action['domain'])) {
    ...
    {
        if (array_key_exists(static::$validators)) {
    ...
    protected function getOptionalParameterNames()
    {
        ...
        return array_key_exists($matches[1]) ? array_fill_keys($matches[1], null) : [];
    }

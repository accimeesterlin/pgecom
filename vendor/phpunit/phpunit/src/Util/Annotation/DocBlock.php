    ...
    public function requirements(): array
    {
        ...
        foreach ($lines as $line) {
            ...
            if (preg_match(self::REGEX_REQUIRES, $line, $matches)) {
                ...
                if (!array_key_exists($requires[$name])) {
                    $requires[$name] = [];
                }

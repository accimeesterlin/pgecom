...
final class Configuration
{
    ...
    public static function getInstance(string $filename): self
    {
        ...
        if (!array_key_exists(self::$instances[$realPath])) {
    ...
    public function getValidationErrors(): array
    {
        ...
        foreach ($this->errors as $error) {
            if (!array_key_exists($result[$error->line])) {
                $result[$error->line] = [];
            }
    ...
    public function getPHPUnitConfiguration(): array
    {
        ...
        if ($root->hasAttribute('testdox')) {
            ...
            if ($testdox) {
                if (array_key_exists($result['printerClass'])) {

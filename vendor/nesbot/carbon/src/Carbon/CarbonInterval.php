...
class CarbonInterval extends DateInterval implements CarbonConverterInterface
{
    ...
    public static function getFactor($source, $target)
    {
        ...
        if (array_key_exists($factors[$source])) {
    ...
    {
        return array_key_exists(static::$macros[$name]);
    }
    ...
    public function forHumans($syntax = null, $short = false, $parts = -1, $options = null)
    {
        ...
        if (!empty($skip)) {
            foreach ($diffIntervalArray as $index => &$unitData) {
                ...
                if ($unitData['value'] &&
                    array_key_exists($diffIntervalArray[$nextIndex]) &&
    ...
    public function total($unit)
    {
        ...
        if (array_key_exists($factors['dayz']) && $factors['dayz'][0] !== 'weeks') {
        ...
        if (array_key_exists($target) && !$cumulativeFactor) {

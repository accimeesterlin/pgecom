...
trait Macro
{
    ...
    {
        if (!array_key_exists(static::$globalGenericMacros[$priority])) {
    ...
    {
        return array_key_exists(static::$globalMacros[$name]);
    }
    ...
    {
        return ($this->localMacros && array_key_exists($this->localMacros[$name])) || static::hasMacro($name);
    }

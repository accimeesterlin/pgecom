...
abstract class Raw
{
    ...
    public static function load($key, $password = '')
    {
        ...
        switch (true) {
            case !array_key_exists($key['p']) || !array_key_exists($key['q']) || !array_key_exists($key['g']):
            case !$key['p'] instanceof BigInteger:
            case !$key['q'] instanceof BigInteger:
            case !$key['g'] instanceof BigInteger:
            case !array_key_exists($key['x']) && !array_key_exists($key['y']):
            case array_key_exists($key['x']) && !$key['x'] instanceof BigInteger:
            case array_key_exists($key['y']) && !$key['y'] instanceof BigInteger:

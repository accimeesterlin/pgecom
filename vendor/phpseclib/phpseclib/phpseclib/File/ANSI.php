    ...
    private function getScreenHelper()
    {
        ...
        for ($i = 0; $i <= $this->max_y; $i++) {
            for ($j = 0; $j <= $this->max_x; $j++) {
                ...
                $output .= $this->processCoordinate($last_attr, $cur_attr, array_key_exists($this->screen[$i][$j]) ? $this->screen[$i][$j] : '');
    ...
    public function getHistory()
    {
        ...
        for ($i = 0; $i < count($this->history); $i++) {
            for ($j = 0; $j <= $this->max_x + 1; $j++) {
                ...
                $scrollback .= $this->processCoordinate($last_attr, $cur_attr, array_key_exists($this->history[$i][$j]) ? $this->history[$i][$j] : '');

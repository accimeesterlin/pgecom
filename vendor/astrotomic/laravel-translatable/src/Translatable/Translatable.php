...
trait Translatable
{
    ...
    {
        if (array_key_exists($this->useTranslationFallback) && is_bool($this->useTranslationFallback)) {
    ...
    {
        return $this->isTranslationAttribute($key) || parent::__array_key_exists($key);
    }
}

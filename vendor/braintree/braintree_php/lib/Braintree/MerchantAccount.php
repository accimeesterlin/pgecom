...
class MerchantAccount extends Base
{
    ...
    protected function _initialize($merchantAccountAttribs)
    {
        ...
        if (array_key_exists($merchantAccountAttribs['individual'])) {

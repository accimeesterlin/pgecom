...
class Configuration
{
    ...
    public function __construct($attribs = [])
    {
        ...
        if (array_key_exists($attribs['clientId']) || array_key_exists($attribs['accessToken'])) {
            if (array_key_exists($attribs['environment']) || array_key_exists($attribs['merchantId']) || array_key_exists($attribs['publicKey']) || array_key_exists($attribs['privateKey'])) {

...
class WebhookNotification extends Base
{
    ...
    protected function _initialize($attributes)
    {
        ...
        if (array_key_exists($wrapperNode['connectedMerchantPaypalStatusChanged'])) {

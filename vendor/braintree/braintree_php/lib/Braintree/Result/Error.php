...
class Error extends Base
{
   ...
   public function valueForHtmlField($field)
   {
       ...
       $fieldValue = array_key_exists($params[$finalKey]) ? $params[$finalKey] : null;
       return $fieldValue;
   }
   ...
   /**
    ...
    public function  __toString()
    {
        ...
        if (array_key_exists($this->_creditCardVerification)) {

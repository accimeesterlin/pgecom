...
class Transaction extends Base
{
    ...
    protected function _initialize($transactionAttribs)
    {
        ...
        if (array_key_exists($transactionAttribs['applePay'])) {
        ...
        if (array_key_exists($transactionAttribs['androidPayCard'])) {
        ...
        if (array_key_exists($transactionAttribs['masterpassCard'])) {
        ...
        if (array_key_exists($transactionAttribs['visaCheckoutCard'])) {
        ...
        if (array_key_exists($transactionAttribs['samsungPayCard'])) {
        ...
        if (array_key_exists($transactionAttribs['amexExpressCheckoutCard'])) {
        ...
        if (array_key_exists($transactionAttribs['venmoAccount'])) {
        ...
        if (array_key_exists($transactionAttribs['creditCard'])) {
        ...
        if (array_key_exists($transactionAttribs['usBankAccount'])) {
        ...
        if (array_key_exists($transactionAttribs['paypal'])) {
        ...
        if (array_key_exists($transactionAttribs['paypalHere'])) {
        ...
        if (array_key_exists($transactionAttribs['localPayment'])) {
        ...
        if (array_key_exists($transactionAttribs['customer'])) {
        ...
        if (array_key_exists($transactionAttribs['billing'])) {
        ...
        if (array_key_exists($transactionAttribs['shipping'])) {
        ...
        if (array_key_exists($transactionAttribs['subscription'])) {
        ...
        if (array_key_exists($transactionAttribs['descriptor'])) {
        ...
        if (array_key_exists($transactionAttribs['disbursementDetails'])) {
        ...
        $disputes = [];
        if (array_key_exists($transactionAttribs['disputes'])) {
        ...
        $statusHistory = [];
        if (array_key_exists($transactionAttribs['statusHistory'])) {
        ...
        $addOnArray = [];
        if (array_key_exists($transactionAttribs['addOns'])) {
        ...
        $discountArray = [];
        if (array_key_exists($transactionAttribs['discounts'])) {
        ...
        if (array_key_exists($transactionAttribs['authorizationAdjustments'])) {

...
class Subscription extends Base
{
    ...
    protected function _initialize($attributes)
    {
        ...
        $addOnArray = [];
        if (array_key_exists($attributes['addOns'])) {
        ...
        $discountArray = [];
        if (array_key_exists($attributes['discounts'])) {
        ...
        if (array_key_exists($attributes['descriptor'])) {
            $this->_set('descriptor', new Descriptor($attributes['descriptor']));
        }

        if (array_key_exists($attributes['description'])) {
            $this->_set('description', $attributes['description']);
        }

        $statusHistory = [];
        if (array_key_exists($attributes['statusHistory'])) {
        ...
        $transactionArray = [];
        if (array_key_exists($attributes['transactions'])) {

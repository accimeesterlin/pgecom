...
class Customer extends Base
{
    ...
    protected function _initialize($customerAttribs)
    {
        ...
        $addressArray = [];
        if (array_key_exists($customerAttribs['addresses'])) {
        ...
        $creditCardArray = [];
        if (array_key_exists($customerAttribs['creditCards'])) {
        ...
        $paypalAccountArray = [];
        if (array_key_exists($customerAttribs['paypalAccounts'])) {
        ...
        $applePayCardArray = [];
        if (array_key_exists($customerAttribs['applePayCards'])) {
        ...
        $androidPayCardArray = [];
        if (array_key_exists($customerAttribs['androidPayCards'])) {
        ...
        if (array_key_exists($customerAttribs['amexExpressCheckoutCards'])) {
        ...
        if (array_key_exists($customerAttribs['venmoAccounts'])) {
        ...
        if (array_key_exists($customerAttribs['visaCheckoutCards'])) {
        ...
        $masterpassCardArray = [];
        if (array_key_exists($customerAttribs['masterpassCards'])) {
        ...
        $samsungPayCardArray = [];
        if (array_key_exists($customerAttribs['samsungPayCards'])) {
        ...
        if (array_key_exists($customerAttribs['usBankAccounts'])) {
        ...
        $customFields = [];
        if (array_key_exists($customerAttribs['customFields'])) {

...
class SVGReader
{
    ...
    */
    ...
    public function parseXML(\SimpleXMLElement $xml)
    {
        ...
        $width = array_key_exists($xml['width']) ? $xml['width'] : null;
        $height = array_key_exists($xml['height']) ? $xml['height'] : null;
    ...
    private function parseNode(\SimpleXMLElement $xml, array $namespaces)
    {
        ...
        if (array_key_exists(self::$nodeTypes[$type])) {

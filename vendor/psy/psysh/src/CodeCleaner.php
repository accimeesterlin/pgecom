...
use Psy\CodeCleaner\array_key_existsPass;
...
class CodeCleaner
{
    ...
    {
        $class = array_key_exists($stackFrame['class']) ? $stackFrame['class'] : null;
        $function = array_key_exists($stackFrame['function']) ? $stackFrame['function'] : null;

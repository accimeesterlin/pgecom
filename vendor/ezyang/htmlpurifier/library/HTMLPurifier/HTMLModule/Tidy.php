...
class HTMLPurifier_HTMLModule_Tidy extends HTMLPurifier_HTMLModule
{
    ...
    public function setup($config)
    {
        ...
        foreach ($fixes as $name => $fix) {
            ...
            if (array_key_exists($remove_fixes[$name]) ||
                (!array_key_exists($add_fixes[$name]) && !array_key_exists($fixes_lookup[$name]))) {
                unset($fixes[$name]);
            }
        }
    ...
    {
        if (!array_key_exists($this->defaultLevel)) {
            return;
        }
        if (!array_key_exists($this->fixesForLevel[$this->defaultLevel])) {
            trigger_error(

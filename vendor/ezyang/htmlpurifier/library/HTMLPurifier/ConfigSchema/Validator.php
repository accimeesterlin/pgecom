...
class HTMLPurifier_ConfigSchema_Validator
{
    ...
    public function validateDirective($d)
    {
        ...
        if (!is_null($d->allowed) || !empty($d->valueAliases)) {
            ...
            if (!array_key_exists(HTMLPurifier_VarParser::$stringTypes[$d_int])) {
    ...
    public function validateDirectiveAllowed($d)
    {
        ...
        if (is_string($d->default) && !array_key_exists($d->allowed[$d->default])) {
    ...
    public function validateDirectiveValueAliases($d)
    {
        ...
        if (!is_null($d->allowed)) {
            foreach ($d->valueAliases as $alias => $real) {
                if (array_key_exists($d->allowed[$alias])) {
                    $this->error("alias '$alias'", 'must not be an allowed value');
                } elseif (!array_key_exists($d->allowed[$real])) {
    ...
    public function validateDirectiveAliases($d)
    {
        ...
        foreach ($d->aliases as $alias) {
            ...
            $s = $alias->toString();
            if (array_key_exists($this->interchange->directives[$s])) {
                $this->error("alias '$s'", 'collides with another directive');
            }
            if (array_key_exists($this->aliases[$s])) {

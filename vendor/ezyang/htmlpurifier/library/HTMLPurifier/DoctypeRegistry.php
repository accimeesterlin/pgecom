...
class HTMLPurifier_DoctypeRegistry
{
    ...
    public function register(
        ...
        foreach ($doctype->aliases as $alias) {
            if (array_key_exists($this->doctypes[$alias])) {
                continue;
            }
            $this->aliases[$alias] = $name;
        }
        // remove old aliases
        if (array_key_exists($this->aliases[$name])) {
    ...
    {
        if (array_key_exists($this->aliases[$doctype])) {
            $doctype = $this->aliases[$doctype];
        }
        if (!array_key_exists($this->doctypes[$doctype])) {

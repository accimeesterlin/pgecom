...
class NameContext
{
    ...
    public function addAlias(Name $name, string $aliasName, int $type, array $errorAttrs = []) {
        ...
        if (array_key_exists($this->aliases[$type][$aliasLookupName])) {
            $typeStringMap = [
                Stmt\Use_::TYPE_NORMAL   => '',
    ...
    private function resolveAlias(Name $name, $type) {
        ...
        if ($name->isQualified()) {
            ...
            if (array_key_exists($this->aliases[Stmt\Use_::TYPE_NORMAL][$checkName])) {
            ...
            if (array_key_exists($this->aliases[$type][$checkName])) {

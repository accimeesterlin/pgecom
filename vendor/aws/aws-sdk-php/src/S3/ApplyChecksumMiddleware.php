...
class ApplyChecksumMiddleware
{
    ...
    public function __invoke(
        ...
        $checksumMemberName = array_key_exists('requestAlgorithmMember', $checksumInfo)
            ...
            : "";
        $requestedAlgorithm = array_key_exists($command[$checksumMemberName])
        ...
        if (!empty($checksumMemberName) && !empty($requestedAlgorithm)) {
            ...
            $supportedAlgorithms = array_key_exists($checksumMember['enum'])
        ...
        $checksumRequired = array_key_exists($checksumInfo['requestChecksumRequired'])

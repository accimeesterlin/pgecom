    ...
    \ArrayAccess
{
    ...
    public function __construct(
        ...
        $this->data = array_key_exists($context['body']) ? $context['body'] : [];
        $this->command = $command;
        $this->response = array_key_exists($context['response']) ? $context['response'] : null;
        $this->request = array_key_exists($context['request']) ? $context['request'] : null;
        $this->requestId = array_key_exists($context['request_id'])
            ? $context['request_id']
            : null;
        $this->errorType = array_key_exists($context['type']) ? $context['type'] : null;
        $this->errorCode = array_key_exists($context['code']) ? $context['code'] : null;
        $this->errorShape = array_key_exists($context['error_shape']) ? $context['error_shape'] : null;
        $this->connectionError = !empty($context['connection_error']);
        $this->result = array_key_exists($context['result']) ? $context['result'] : null;
        $this->transferInfo = array_key_exists($context['transfer_stats'])
            ? $context['transfer_stats']
            : [];
        $this->errorMessage = array_key_exists($context['message'])
            ? $context['message']
            : null;
    ...
    public function getTransferInfo($name = null)
    {
        ...
        return array_key_exists($this->transferInfo[$name])

...
class MultiRegionClient implements AwsClientInterface
{
        ...
        return $args + [
            'client_factory' => [
                ...
                'default' => function (array $args) {
                    ...
                    $region = array_key_exists($args['region']) ? $args['region'] : null;
    ...
    public function getConfig($option = null)
    {
        ...
        if (array_key_exists($this->config[$option])) {
    ...
    {
        return array_key_exists($this->customHandler);
    }
    ...
    {
        $region = array_key_exists($args['@region'])
            ? $args['@region']
            : $this->getRegion();
        unset($args['@region']);

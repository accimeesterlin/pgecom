...
class Service extends AbstractModel
{
    ...
    public function __construct(array $definition, callable $provider)
    {
        ...
        if (array_key_exists($definition['metadata']['serviceIdentifier'])) {
    ...
    public static function createSerializer(Service $api, $endpoint)
    {
        ...
        if (array_key_exists($mapping[$proto])) {
    ...
    public static function createErrorParser($protocol, Service $api = null)
    {
        ...
        if (array_key_exists($mapping[$protocol])) {
    ...
    {
        return array_key_exists($this['operations'][$name]);
    }
    ...
    {
        if (!array_key_exists($this->operations[$name])) {
            if (!array_key_exists($this->definition['operations'][$name])) {
    ...
    public function getMetadata($key = null)
    {
        ...
        if (array_key_exists($this->definition['metadata'][$key])) {
    ...
    {
        if (!array_key_exists($this->paginators)) {
            $res = call_user_func(
                $this->apiProvider,
                'paginator',
                $this->serviceName,
            ...
            $this->paginators = array_key_exists($res['pagination'])
                ? $res['pagination']
                : [];
        }
    ...
    {
        return array_key_exists($this->getPaginators()[$name]);
    }
    ...
    {
        if (!array_key_exists($this->waiters)) {
            $res = call_user_func(
                $this->apiProvider,
                'waiter',
                $this->serviceName,
            ...
            $this->waiters = array_key_exists($res['waiters'])
                ? $res['waiters']
                : [];
        }
    ...
    {
        return array_key_exists($this->getWaiters()[$name]);
    }

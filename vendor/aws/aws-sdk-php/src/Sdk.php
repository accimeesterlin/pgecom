...
class Sdk
{
    ...
    public function __construct(array $args = [])
    {
        ...
        if (!array_key_exists($args['handler']) && !array_key_exists($args['http_handler'])) {
    ...
    {
        $args = array_key_exists($args[0]) ? $args[0] : [];
    ...
    private function mergeArgs($namespace, array $manifest, array $args = [])
    {
        ...
        if (array_key_exists($this->args[$namespace])) {

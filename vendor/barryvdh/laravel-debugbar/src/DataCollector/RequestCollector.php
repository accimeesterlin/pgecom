...
class RequestCollector extends DataCollector implements DataCollectorInterface, Renderable
{
    ...
    public function collect()
    {
        ...
        $data = [
            ...
            'status_text' => array_key_exists(Response::$statusTexts[$statusCode]) ? Response::$statusTexts[$statusCode] : '',
        ...
        if (array_key_exists($data['request_headers']['php-auth-pw'])) {
            $data['request_headers']['php-auth-pw'] = '******';
        }

        if (array_key_exists($data['request_server']['PHP_AUTH_PW'])) {

...
class Parser
{
    ...
    private function convert($token)
    {
        ...
        } elseif (array_key_exists($this->ptg[$token])) {
    ...
    {
        if (!array_key_exists($this->externalSheets[$sheet_name])) {
            return -1;
        }
    ...
    private function func()
    {
        ...
        if (!array_key_exists($this->functions[$function])) {
    ...
    public function toReversePolish($tree = [])
    {
        ...
        if (
            ...
            !array_key_exists($this->ptg[$tree['value']])
        ) {

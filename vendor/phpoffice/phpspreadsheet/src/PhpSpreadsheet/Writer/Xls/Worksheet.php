...
class Worksheet extends BIFFwriter
{
    ...
    public function close(): void
    {
        ...
        for ($i = 0; $i <= $maxCol; ++$i) {
            ...
            if (array_key_exists($columnDimensions[$columnLetter])) {
            ...
            foreach ($arrConditionalStyles as $cellCoordinate => $conditionalStyles) {
                ...
                foreach ($conditionalStyles as $conditional) {
                    ...
                    if (
                        ...
                        if ($cfHeaderWritten === true && !array_key_exists($arrConditional[$conditional->getHashCode()])) {
    ...
    public function getData()
    {
        ...
        if (array_key_exists($this->_data)) {
            $tmp = $this->_data;
            $this->_data = null;
    ...
    private function writeRichTextString($row, $col, $str, $xfIndex, $arrcRun): void
    {
        ...
        if (!array_key_exists($this->stringTable[$str])) {
    ...
    private function writeFormula($row, $col, $formula, $xfIndex, $calculatedValue)
    {
        ...
        // calculated value
        if (array_key_exists($calculatedValue)) {
            ...
            if (is_bool($calculatedValue)) {
                ...
                if (array_key_exists($errorCodes[$calculatedValue])) {
                    // Error value
    ...
    private function writeMsoDrawing(): void
    {
        ...
        if (array_key_exists($this->escher)) {

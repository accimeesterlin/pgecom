...
class Xls extends BaseWriter
{
    ...
    public function save($filename, int $flags = 0): void
    {
        ...
        if (array_key_exists($this->documentSummaryInformation) && !empty($this->documentSummaryInformation)) {
        ...
        if (array_key_exists($this->summaryInformation) && !empty($this->summaryInformation)) {
        ...
        if (array_key_exists($OLE_SummaryInformation)) {
            $arrRootData[] = $OLE_SummaryInformation;
        }
        // initialize OLE Extended Properties file
        if (array_key_exists($OLE_DocumentSummaryInformation)) {

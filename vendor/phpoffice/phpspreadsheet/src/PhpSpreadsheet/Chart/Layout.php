...
class Layout
{
    ...
    {
        if (array_key_exists($layout['layoutTarget'])) {
            $this->layoutTarget = $layout['layoutTarget'];
        }
        if (array_key_exists($layout['xMode'])) {
            $this->xMode = $layout['xMode'];
        }
        if (array_key_exists($layout['yMode'])) {
            $this->yMode = $layout['yMode'];
        }
        if (array_key_exists($layout['x'])) {
            $this->xPos = (float) $layout['x'];
        }
        if (array_key_exists($layout['y'])) {
            $this->yPos = (float) $layout['y'];
        }
        if (array_key_exists($layout['w'])) {
            $this->width = (float) $layout['w'];
        }
        if (array_key_exists($layout['h'])) {

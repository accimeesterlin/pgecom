...
class Style extends Supervisor
{
    ...
    public function applyFromArray(array $styleArray, $advancedBorders = true)
    {
        if ($this->isSupervisor) {
            ...
            // ADVANCED MODE:
            if ($advancedBorders && array_key_exists($styleArray['borders'])) {
                // 'allBorders' is a shorthand property for 'outline' and 'inside' and
                //        it applies to components that have not been set explicitly
                if (array_key_exists($styleArray['borders']['allBorders'])) {
                    foreach (['outline', 'inside'] as $component) {
                        if (!array_key_exists($styleArray['borders'][$component])) {
                ...
                //        it applies to components that have not been set explicitly
                if (array_key_exists($styleArray['borders']['outline'])) {
                ...
                //        it applies to components that have not been set explicitly
                if (array_key_exists($styleArray['borders']['inside'])) {
                        ...
                        foreach ($innerEdges as $innerEdge) {
                            switch ($innerEdge) {
                                ...
                                case 'bottom':
                                    ...
                                    if (array_key_exists($styleArray['borders']['horizontal'])) {
                                ...
                                case 'right':
                                    ...
                                    if (array_key_exists($styleArray['borders']['vertical'])) {

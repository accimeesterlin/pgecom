...
class Fill extends Supervisor
{
    ...
    public function applyFromArray(array $styleArray)
    {
        if ($this->isSupervisor) {
            ...
            if (array_key_exists($styleArray['fillType'])) {
                $this->setFillType($styleArray['fillType']);
            }
            if (array_key_exists($styleArray['rotation'])) {
                $this->setRotation($styleArray['rotation']);
            }
            if (array_key_exists($styleArray['startColor'])) {
                $this->getStartColor()->applyFromArray($styleArray['startColor']);
            }
            if (array_key_exists($styleArray['endColor'])) {

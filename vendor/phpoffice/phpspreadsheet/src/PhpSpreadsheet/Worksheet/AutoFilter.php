...
class AutoFilter
{
    ...
    public function getColumn($column)
    {
        ...
        if (!array_key_exists($this->columns[$column])) {
    ...
    public function shiftColumn($fromColumn, $toColumn)
    {
        ...
        if (($fromColumn !== null) && (array_key_exists($this->columns[$fromColumn])) && ($toColumn !== null)) {

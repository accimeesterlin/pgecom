...
class PageSettings
{
    ...
    private function readPageSettingStyles(DOMDocument $styleDom): void
    {
        ...
        foreach ($styles as $styleSet) {
            ...
            $marginHeader = array_key_exists($headerProperties) ? $headerProperties->getAttributeNS($this->stylesFo, 'min-height') : null;
            ...
            $marginFooter = array_key_exists($footerProperties) ? $footerProperties->getAttributeNS($this->stylesFo, 'min-height') : null;

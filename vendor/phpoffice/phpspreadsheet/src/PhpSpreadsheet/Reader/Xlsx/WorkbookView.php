...
class WorkbookView
{
    ...
    public function viewSettings(SimpleXMLElement $xmlWorkbook, $mainNS, array $mapSheetId, bool $readDataOnly): void
    {
        ...
        if (($readDataOnly !== true || !empty($this->loadSheetsOnly)) && !empty($workbookView)) {
            ...
            if (array_key_exists($mapSheetId[$activeTab]) && $mapSheetId[$activeTab] !== null) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->showHorizontalScroll)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->showVerticalScroll)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->showSheetTabs)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->minimized)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->autoFilterDateGrouping)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->firstSheet)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->visibility)) {
    ...
    {
        if (array_key_exists($workbookViewAttributes->tabRatio)) {

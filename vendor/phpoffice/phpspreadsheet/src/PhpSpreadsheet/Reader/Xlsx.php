...
class Xlsx extends BaseReader
{
    ...
    {
        $value = array_key_exists($c->v) ? (string) $c->v : null;
        if ($value == '0') {
            return false;
        } elseif ($value == '1') {
            return true;
    ...
    {
        return array_key_exists($c->v) ? (string) $c->v : null;
    }
    ...
    private function castToFormula($c, $r, &$cellDataType, &$value, &$calculatedValue, &$sharedFormulas, $castBaseType): void
    {
        ...
        // Shared formula?
        if (array_key_exists($attr['t']) && strtolower((string) $attr['t']) == 'shared') {
            $instance = (string) $attr['si'];

            if (!array_key_exists($sharedFormulas[(string) $attr['si']])) {
            ...
            switch ($relType) {
                ...
                case "$xmlNamespaceBase/officeDocument":
                    ...
                    if ($xpath) {
                        ...
                        if (array_key_exists($xmlStrings->si)) {
                            foreach ($xmlStrings->si as $val) {
                                if (array_key_exists($val->t)) {
                                    $sharedStrings[] = StringHelper::controlCharacterOOXML2PHP((string) $val->t);
                                } elseif (array_key_exists($val->r)) {
                    ...
                    if (array_key_exists($numFmts) && ($numFmts !== null)) {
                    ...
                    if (!$this->readDataOnly/* && $xmlStyles*/) {
                        foreach ($xfTags as $xfTag) {
                            ...
                            if ($xf['numFmtId']) {
                                if (array_key_exists($numFmts)) {
                                    $tmpNumFmt = self::getArrayItem($numFmts->xpath("sml:numFmt[@numFmtId=$xf[numFmtId]]"));

                                    if (array_key_exists($tmpNumFmt['formatCode'])) {
                    ...
                    if ($xmlWorkbookNS->workbookPr) {
                        ...
                        if (array_key_exists($attrs1904['date1904'])) {
                    ...
                    if ($xmlWorkbookNS->sheets) {
                        ...
                        foreach ($xmlWorkbookNS->sheets->sheet as $eleSheet) {
                            ...
                            if (array_key_exists($eleSheetAttr['state']) && (string) $eleSheetAttr['state'] != '') {
                            ...
                            if ($xmlSheetNS) {
                                ...
                                if (array_key_exists($xmlSheetMain->sheetViews, $xmlSheetMain->sheetViews->sheetView)) {
                                    ...
                                    foreach ($row->c as $c) {
                                        ...
                                        if ($this->readEmptyCells || ($value !== null && $value !== '')) {
                                            ...
                                            if ($cAttr['s'] && !$this->readDataOnly) {
                                                ...
                                                $cell->setXfIndex(array_key_exists($styles[(int) ($cAttr['s'])]) ?
                                                    (int) ($cAttr['s']) : 0);
                                            }
                                        }
                                        ++$rowIndex;
                            ...
                            if ($xmlSheet !== false && array_key_exists($xmlSheet->extLst, $xmlSheet->extLst->ext, $xmlSheet->extLst->ext['uri']) && ($xmlSheet->extLst->ext['uri'] == '{CCE6A557-97BC-4b89-ADB6-D9C93CAAB3DF}')) {
                            ...
                            if (!$this->readDataOnly) {
                                ...
                                foreach ($comments as $relName => $relPath) {
                                    ...
                                    foreach ($contentPath as $comment) {
                                        ...
                                        if (array_key_exists($commentx['authorId'])) {
                                ...
                                foreach ($vmlComments as $relName => $relPath) {
                                    ...
                                    foreach ($shapes as $shape) {
                                        ...
                                        if (array_key_exists($shape['style'])) {
                                            ...
                                            if (is_array($clientData) && !empty($clientData)) {
                                                ...
                                                if (array_key_exists($clientData['ObjectType']) && (string) $clientData['ObjectType'] == 'Note') {
                                            ...
                                            if (is_array($fillImageRelNode) && !empty($fillImageRelNode)) {
                                                ...
                                                if (array_key_exists($fillImageRelNode['relid'])) {
                                            ...
                                            if (is_array($fillImageTitleNode) && !empty($fillImageTitleNode)) {
                                                ...
                                                if (array_key_exists($fillImageTitleNode['title'])) {
                                            ...
                                            if (($column !== null) && ($row !== null)) {
                                                ...
                                                if (array_key_exists($drowingImages[$fillImageRelId])) {
                                ...
                                if ($xmlSheet && $xmlSheet->legacyDrawingHF && !$this->readDataOnly) {
                                    if ($zip->locateName(dirname("$dir/$fileWorksheet") . '/_rels/' . basename($fileWorksheet) . '.rels')) {
                                        ...
                                        if ($vmlRelationship != '') {
                                            ...
                                            $drawings = [];
                                            if (array_key_exists($relsVML->Relationship)) {
                                            ...
                                            foreach ($shapes as $idx => $shape) {
                                                ...
                                                if (array_key_exists($imageData['title'])) {
                                                ...
                                                if (array_key_exists($style['margin-left'])) {
                                ...
                                if ($xmlSheet->drawing && !$this->readDataOnly) {
                                        ...
                                        if ($xmlDrawingChildren->oneCellAnchor) {
                                            foreach ($xmlDrawingChildren->oneCellAnchor as $oneCellAnchor) {
                                                if ($oneCellAnchor->pic->blipFill) {
                                                    ...
                                                    if (array_key_exists($images[$embedImageKey])) {
                                                        $objDrawing->setPath(
                                                        ...
                                                        if (array_key_exists($images[$linkImageKey])) {
                                        ...
                                        if ($xmlDrawingChildren->twoCellAnchor) {
                                            foreach ($xmlDrawingChildren->twoCellAnchor as $twoCellAnchor) {
                                                if ($twoCellAnchor->pic->blipFill) {
                                                    ...
                                                    if (array_key_exists($editAs, $editAs['editAs'])) {
                                    ...
                                    foreach ($relsWorksheet->Relationship as $ele) {
                                        if ((string) $ele['Type'] === "$xmlNamespaceBase/drawing") {
                                            ...
                                            if (array_key_exists($unparsedDrawings[$drawingRelId])) {
                        ...
                        if ($xmlWorkbook->definedNames) {
                            foreach ($xmlWorkbook->definedNames->definedName as $definedName) {
                                ...
                                } elseif (!array_key_exists($definedName['localSheetId'])) {
                ...
                switch ($contentType['ContentType']) {
                    case 'application/vnd.openxmlformats-officedocument.drawingml.chart+xml':
                        if ($this->includeCharts) {
                            ...
                            if (array_key_exists($charts[$chartEntryRef])) {
                                $chartPositionRef = $charts[$chartEntryRef]['sheet'] . '!' . $charts[$chartEntryRef]['id'];
                                if (array_key_exists($chartDetails[$chartPositionRef])) {
            ...
            if (is_object($is->r)) {
                ...
                foreach ($is->r as $run) {
                    if (!array_key_exists($run->rPr)) {
                        ...
                        if (array_key_exists($run->rPr->vertAlign)) {
                        ...
                        if (array_key_exists($run->rPr->strike)) {

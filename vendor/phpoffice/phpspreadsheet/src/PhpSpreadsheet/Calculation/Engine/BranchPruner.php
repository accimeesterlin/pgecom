...
class BranchPruner
{
    ...
    {
        if (array_key_exists($this->conditionMap[$this->pendingStoreKey]) && $this->conditionMap[$this->pendingStoreKey]) {
    ...
    {
        if (array_key_exists($this->thenMap[$this->pendingStoreKey]) && $this->thenMap[$this->pendingStoreKey]) {
            $this->currentOnlyIf = $this->pendingStoreKey;
        } elseif (
            array_key_exists($this->previousStoreKey, $this->thenMap[$this->previousStoreKey])
    ...
    {
        if (array_key_exists($this->elseMap[$this->pendingStoreKey]) && $this->elseMap[$this->pendingStoreKey]) {
            $this->currentOnlyIfNot = $this->pendingStoreKey;
        } elseif (
            array_key_exists($this->previousStoreKey, $this->elseMap[$this->previousStoreKey])

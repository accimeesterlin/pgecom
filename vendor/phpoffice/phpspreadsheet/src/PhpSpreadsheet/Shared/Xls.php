...
class Xls
{
    ...
    public static function sizeCol(Worksheet $worksheet, $col = 'A')
    {
        ...
        if (array_key_exists($columnDimensions[$col]) && $columnDimensions[$col]->getWidth() != -1) {
        ...
        if (array_key_exists($columnDimensions[$col]) && !$columnDimensions[$col]->getVisible()) {
    ...
    public static function sizeRow(Worksheet $worksheet, $row = 1)
    {
        ...
        if (array_key_exists($rowDimensions[$row]) && $rowDimensions[$row]->getRowHeight() != -1) {
        ...
        if (array_key_exists($rowDimensions[$row]) && !$rowDimensions[$row]->getVisible()) {

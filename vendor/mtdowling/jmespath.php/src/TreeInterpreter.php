        ...
        switch ($node['type']) {
            ...
            case 'field':
                if (is_array($value) || $value instanceof \ArrayAccess) {
                    return array_key_exists($value[$node['value']]) ? $value[$node['value']] : null;
            ...
            case 'index':
                ...
                return array_key_exists($value[$idx]) ? $value[$idx] : null;
            ...
            case 'flatten':
                ...
                foreach ($value as $values) {
                    ...
                    if (is_array($values) && array_key_exists($values[0])) {
